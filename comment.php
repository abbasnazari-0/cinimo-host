...
function submitComment($conn){
    ...
    // insert comment data
    $sql = "INSERT INTO tbl_comment (comment, user_tag, vid_tag, time) VALUES ('$comment_message', '$comment_user_tag', '$comment_vid_tag' , '$date')";
...
// get comment data
$sql = "SELECT * FROM tbl_comment WHERE vid_tag =  '$video_tags'";
